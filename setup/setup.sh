...
echo "-- Create Kafka topic (connected-plants)"
kafka-topics --zookeeper edge2ai-1.dim.local:2181 --create --topic connected-plants --partitions 5 --replication-factor 1
kafka-topics --zookeeper edge2ai-1.dim.local:2181 --describe --topic connected-plants
